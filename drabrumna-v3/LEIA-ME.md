# Site Dra. Brumna Valdivieso — v3

Versão de consolidação: parte da v2 e recupera o que a v1 fazia melhor.
Prévia em `https://thallisribeiro.com.br/drabrumna-v3/`.

Site estático, sem build, sem dependência além das fontes do Google.
